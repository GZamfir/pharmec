...
-- Dumping data for table pharmec.ph_assets: ~54 rows (aproximativ)
...
INSERT INTO `ph_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
	...
	(54, 18, 70, 71, 2, 'com_modules.module.87', 'Pharmec Slider', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
	(55, 18, 72, 73, 2, 'com_modules.module.88', 'Pharmec Parteneri', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
	(57, 1, 105, 106, 1, 'com_partner', 'COM_PARTNER', '{}');
...
-- Dumping data for table pharmec.ph_categories: ~6 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_content: ~0 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_content_types: ~15 rows (aproximativ)
...
INSERT INTO `ph_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
	...
	(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"817e29a5fe996afcd8051ec434cccfa2"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
-- Dumping data for table pharmec.ph_menu: ~23 rows (aproximativ)
DELETE FROM `ph_menu`;
...
-- Dumping data for table pharmec.ph_partner: 2 rows
...
-- Dumping data for table pharmec.ph_ucm_history: ~0 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_updates: ~58 rows (aproximativ)
...
INSERT INTO `ph_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1431766001, ''),
	(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1431766001, ''),
	(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1431765999, ''),
	(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1431765999, '');
...
INSERT INTO `ph_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(502, 'Super User', 'zamfir.gaby', 'zamfir.gaby@gmail.com', '$2y$10$CGWBxrHMSBReDPC99wOAQuacGhfmBkwWbumkHPjax2kGB8VCgJd8C', 0, 1, '2015-05-07 18:49:28', '2015-05-16 08:46:34', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
