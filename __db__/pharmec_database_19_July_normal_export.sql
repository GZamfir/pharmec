...
-- Dumping data for table pharmec.ph_assets: ~78 rows (aproximativ)
...
INSERT INTO `ph_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
	...
	(18, 1, 55, 98, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
	...
	(78, 1, 147, 152, 1, 'com_book', 'COM_BOOK', '{}'),
	(79, 27, 23, 24, 3, 'com_content.article.7', 'Login', '{"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1}}'),
	(80, 1, 153, 154, 1, 'com_phocagallery', 'com_phocagallery', '{"core.admin":[],"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
	(81, 78, 148, 149, 2, 'com_book.category.12', 'Luceafarul', ''),
	(82, 78, 150, 151, 2, 'com_book.category.13', 'Eu nu strivesc corola de minuni a lumii', ''),
	(85, 18, 96, 97, 2, 'com_modules.module.96', 'Meniu', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}');
...
-- Dumping data for table pharmec.ph_book: 1 rows
DELETE FROM `ph_book`;
/*!40000 ALTER TABLE `ph_book` DISABLE KEYS */;
INSERT INTO `ph_book` (`id`, `reader`, `summary`, `catid`, `votes`, `published`) VALUES
	(4, 'Gaby Zamfir', '<p>Test</p>', 12, 1, 1);
...
-- Dumping data for table pharmec.ph_booking: 3 rows
...
INSERT INTO `ph_booking` (`id`, `name_surname`, `company`, `phone`, `city`, `email`, `message`, `service_title`, `published`) VALUES
	(35, 'Test', 'Test', '123', 'Test', 'test@yahoo.com', 'Test', 'Servicii Hardware', 0),
	(36, 'Test', 'test', '123', 'test', 'Test@yahoo.com', 'test', 'Servicii Telekom', 0),
	(37, 'Test', 'test', '123', 'test', 'Test@yahoo.com', 'test', 'Servicii Hardware', 0);
...
-- Dumping data for table pharmec.ph_book_votes: ~16 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_categories: ~9 rows (aproximativ)
...
INSERT INTO `ph_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
	...
	(12, 81, 1, 19, 20, 1, 'luceafarul', 'com_book', 'Luceafarul', 'luceafarul', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"","image_alt":"","book_author":"Mihai Eminescu","book_genre":"Poezie","book_image":"","book_description":"Luceafărul este una dintre cele mai celebre poezii ale lui Mihai Eminescu, începută încă în 1873, dar scrisă și finisată de-a lungul multor ani până la publicarea sa în aprilie 1883 în Almanahul societății studențești România Jună din Viena. După publicarea la Viena, poemul a fost reluat apoi în același an în revista Convorbiri literare și în final în volumul princeps intitulat „Poesii” sub îngrijirea lui Titu Maiorescu.","book_ebook_link":""}', '', '', '{"author":"","robots":""}', 502, '2015-07-19 14:16:51', 0, '2015-07-19 14:16:51', 0, '*', 1);
...
-- Dumping data for table pharmec.ph_extensions: ~155 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_menu: ~64 rows (aproximativ)
DELETE FROM `ph_menu`;
...
INSERT INTO `ph_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
	...
	(122, 'main', 'JCE', 'jce', '', 'jce', 'index.php?option=com_jce', 'component', 0, 1, 1, 10010, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/logo.png', 0, '', 63, 72, 0, '', 1),
	(123, 'main', 'WF_MENU_CPANEL', 'wf-menu-cpanel', '', 'jce/wf-menu-cpanel', 'index.php?option=com_jce', 'component', 0, 122, 2, 10010, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-cpanel.png', 0, '', 64, 65, 0, '', 1),
	(124, 'main', 'WF_MENU_CONFIG', 'wf-menu-config', '', 'jce/wf-menu-config', 'index.php?option=com_jce&view=config', 'component', 0, 122, 2, 10010, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-config.png', 0, '', 66, 67, 0, '', 1),
	(125, 'main', 'WF_MENU_PROFILES', 'wf-menu-profiles', '', 'jce/wf-menu-profiles', 'index.php?option=com_jce&view=profiles', 'component', 0, 122, 2, 10010, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-profiles.png', 0, '', 68, 69, 0, '', 1),
	(126, 'main', 'WF_MENU_INSTALL', 'wf-menu-install', '', 'jce/wf-menu-install', 'index.php?option=com_jce&view=installer', 'component', 0, 122, 2, 10010, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-install.png', 0, '', 70, 71, 0, '', 1),
	...
	(128, 'main', 'COM_BOOKING_MENU', 'com-booking-menu', '', 'com-booking-menu', 'index.php?option=com_booking', 'component', 0, 1, 1, 10013, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 75, 76, 0, '', 1),
	(129, 'main', 'PHARMEC DO NOT USE', 'pharmec-do-not-use', '', 'pharmec-do-not-use', 'index.php?option=com_pharmec', 'component', 0, 1, 1, 10016, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 77, 78, 0, '', 1),
	...
	(135, 'main', 'COM_NEWSLETTER_MENU', 'com-newsletter-menu', '', 'com-newsletter-menu', 'index.php?option=com_newsletter', 'component', 0, 1, 1, 10017, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 81, 82, 0, '', 1),
	...
	(141, 'main', 'COM_BOOK_MENU', 'com-book-menu', '', 'com-book-menu', 'index.php?option=com_book', 'component', 0, 1, 1, 10021, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 85, 86, 0, '', 1),
	...
	(145, 'main', 'COM_PHOCAGALLERY', 'com-phocagallery', '', 'com-phocagallery', 'index.php?option=com_phocagallery', 'component', 0, 1, 1, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu.png', 0, '', 93, 120, 0, '', 1),
	(146, 'main', 'COM_PHOCAGALLERY_CONTROLPANEL', 'com-phocagallery-controlpanel', '', 'com-phocagallery/com-phocagallery-controlpanel', 'index.php?option=com_phocagallery', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-control-panel.png', 0, '', 94, 95, 0, '', 1),
	(147, 'main', 'COM_PHOCAGALLERY_IMAGES', 'com-phocagallery-images', '', 'com-phocagallery/com-phocagallery-images', 'index.php?option=com_phocagallery&view=phocagalleryimgs', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-gal.png', 0, '', 96, 97, 0, '', 1),
	(148, 'main', 'COM_PHOCAGALLERY_CATEGORIES', 'com-phocagallery-categories', '', 'com-phocagallery/com-phocagallery-categories', 'index.php?option=com_phocagallery&view=phocagallerycs', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-cat.png', 0, '', 98, 99, 0, '', 1),
	(149, 'main', 'COM_PHOCAGALLERY_THEMES', 'com-phocagallery-themes', '', 'com-phocagallery/com-phocagallery-themes', 'index.php?option=com_phocagallery&view=phocagalleryt', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-theme.png', 0, '', 100, 101, 0, '', 1),
	(150, 'main', 'COM_PHOCAGALLERY_CATEGORYRATING', 'com-phocagallery-categoryrating', '', 'com-phocagallery/com-phocagallery-categoryrating', 'index.php?option=com_phocagallery&view=phocagalleryra', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-vote.png', 0, '', 102, 103, 0, '', 1),
	(151, 'main', 'COM_PHOCAGALLERY_IMAGERATING', 'com-phocagallery-imagerating', '', 'com-phocagallery/com-phocagallery-imagerating', 'index.php?option=com_phocagallery&view=phocagalleryraimg', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-vote-img.png', 0, '', 104, 105, 0, '', 1),
	(152, 'main', 'COM_PHOCAGALLERY_CATEGORYCOMMENTS', 'com-phocagallery-categorycomments', '', 'com-phocagallery/com-phocagallery-categorycomments', 'index.php?option=com_phocagallery&view=phocagallerycos', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-comment.png', 0, '', 106, 107, 0, '', 1),
	(153, 'main', 'COM_PHOCAGALLERY_IMAGECOMMENTS', 'com-phocagallery-imagecomments', '', 'com-phocagallery/com-phocagallery-imagecomments', 'index.php?option=com_phocagallery&view=phocagallerycoimgs', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-comment-img.png', 0, '', 108, 109, 0, '', 1),
	(154, 'main', 'COM_PHOCAGALLERY_USERS', 'com-phocagallery-users', '', 'com-phocagallery/com-phocagallery-users', 'index.php?option=com_phocagallery&view=phocagalleryusers', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-users.png', 0, '', 110, 111, 0, '', 1),
	(155, 'main', 'COM_PHOCAGALLERY_FB', 'com-phocagallery-fb', '', 'com-phocagallery/com-phocagallery-fb', 'index.php?option=com_phocagallery&view=phocagalleryfbs', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-fb.png', 0, '', 112, 113, 0, '', 1),
	(156, 'main', 'COM_PHOCAGALLERY_TAGS', 'com-phocagallery-tags', '', 'com-phocagallery/com-phocagallery-tags', 'index.php?option=com_phocagallery&view=phocagallerytags', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-tags.png', 0, '', 114, 115, 0, '', 1),
	(157, 'main', 'COM_PHOCAGALLERY_STYLES', 'com-phocagallery-styles', '', 'com-phocagallery/com-phocagallery-styles', 'index.php?option=com_phocagallery&view=phocagalleryefs', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-styles.png', 0, '', 116, 117, 0, '', 1),
	(158, 'main', 'COM_PHOCAGALLERY_INFO', 'com-phocagallery-info', '', 'com-phocagallery/com-phocagallery-info', 'index.php?option=com_phocagallery&view=phocagalleryin', 'component', 0, 145, 2, 10023, 0, '0000-00-00 00:00:00', 0, 1, 'media/com_phocagallery/images/administrator/icon-16-pg-menu-info.png', 0, '', 118, 119, 0, '', 1),
	...
	(160, 'mainmenu', 'Noutate 2123', 'noutate-2123', '', 'noutate-2123', 'index.php?option=com_content&view=article&id=2', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 123, 124, 0, '*', 0),
	(161, 'mainmenu', 'Test 1234', 'test-1234', '', 'test-1234', 'index.php?option=com_book&view=books', 'component', 1, 1, 1, 10021, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 125, 126, 0, '*', 0),
	(162, 'mainmenu', 'Soft La Comanda', 'soft-la-comanda', '', 'servicii/soft-la-comanda', 'index.php?option=com_service&view=service&id=9', 'component', 1, 108, 2, 10006, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 56, 57, 0, '*', 0);
...
-- Dumping data for table pharmec.ph_modules_menu: ~30 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_newsletter: 9 rows
...
INSERT INTO `ph_newsletter` (`id`, `email`, `newsletter_type`, `city`, `phone`, `published`) VALUES
	...
	(9, 'abc@yahoo.com', 'Cabinet', 'Test', '123', 0);
...
INSERT INTO `ph_overrider` (`id`, `constant`, `string`, `file`) VALUES
	...
	(1651, 'JLIB_HTML_BEHAVIOR_YEAR_SELECT', '- Use the Ă‚Â« and Ă‚Â» buttons to select year\\n', 'C:\\wamp\\www\\pharmec\\language\\en-GB\\en-GB.lib_joomla.ini'),
...
-- Dumping data for table pharmec.ph_phocagallery_categories: ~0 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_schemas: ~6 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_service: 4 rows
...
INSERT INTO `ph_service` (`id`, `title`, `summary`, `description`, `title_image`, `catid`, `just_description`, `show_in_slider`, `published`) VALUES
	...
	(9, 'Soft La Comanda', '<p><strong>Software custom</strong> (cunoscut și ca software la comanda) este un tip de <a href="https://ro.wikipedia.org/wiki/Software" title="Software">software</a> dezvoltat special pentru anumite organizații, ce include funcționalități specifice pornite de la nevoile particulare ale beneficiarilor. Acesta difera de software-ul disponibil pe piață (cunoscut și ca <a href="https://ro.wikipedia.org/wiki/Software_proprietar" title="Software proprietar">software proprietar</a> sau software de raft). În general nu este adresat vânzării în masa, ci este creat pentru diverse companii sau corporații cu procese de business specifice.</p>', '<p><strong>Software custom</strong> (cunoscut și ca software la comanda) este un tip de <a href="https://ro.wikipedia.org/wiki/Software" title="Software">software</a> dezvoltat special pentru anumite organizații, ce include funcționalități specifice pornite de la nevoile particulare ale beneficiarilor. Acesta difera de software-ul disponibil pe piață (cunoscut și ca <a href="https://ro.wikipedia.org/wiki/Software_proprietar" title="Software proprietar">software proprietar</a> sau software de raft). În general nu este adresat vânzării în masa, ci este creat pentru diverse companii sau corporații cu procese de business specifice.</p>\r\n<p>Companiile apelează la software custom în momentul în care aplicațiile software standard pe care le utilizează nu mai sunt suficiente pentru nevoile de eficientizare ale proceselor lor de business. Investiția într-un software custom este considerabilă, fiind un produs unicat, însă este acoperită prin maximizarea nivelului de flexibilitate și de scalabilitate a funcționalităților, asigurând o acoperire de 100% a nevoilor prezente și viitoare ale beneficiarilor.</p>\r\n<p>Principalele categorii de beneficiari pentru software custom comercial sunt:</p>\r\n<ul>\r\n<li>Companii de productie ce au nevoie de software custom specific fluxurilor proprii pentru optimizarea proceselor de productie</li>\r\n<li>Corporatii ce au nevoie de software custom pentru nevoile specifice mediului de business local si optimizarii proceselor de business</li>\r\n<li>Companii locale medii si mari ce doresc sa includa particularitatile lor de business, in solutiile pe care le folosesc, pentru a isi pastra unicitatea proceselor proprii.</li>\r\n</ul>\r\n<p>Software custom necomercial este intalnit deobicei in mediul academic.</p>', '', 0, 0, 0, 0);
...
INSERT INTO `ph_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
	('3chm0djh7ttdifkim166bu7gs7', 0, 0, '1437315993', '__default|a:9:{s:15:"session.counter";i:43;s:19:"session.timer.start";i:1437315254;s:18:"session.timer.last";i:1437315988;s:17:"session.timer.now";i:1437315992;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:39.0) Gecko/20100101 Firefox/39.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":1:{s:5:"users";O:8:"stdClass":1:{s:5:"login";O:8:"stdClass":1:{s:4:"form";O:8:"stdClass":2:{s:4:"data";a:0:{}s:6:"return";s:16:"/clubul-de-carte";}}}}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":28:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";s:3:"504";s:4:"name";s:6:"guest1";s:8:"username";s:6:"guest1";s:5:"email";s:14:"test@yahoo.com";s:8:"password";s:60:"$2y$10$yFxtOv7uyADjJTX7Ai/VYuaYXq7CV6X.PHq9bcUfwKh4mfmLkNpke";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"0";s:12:"registerDate";s:19:"2015-07-08 07:33:49";s:13:"lastvisitDate";s:19:"2015-07-12 11:15:15";s:10:"activation";s:0:"";s:6:"params";s:2:"{}";s:6:"groups";a:1:{i:2;s:1:"2";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:2;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:2;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"edd9c08bef9a0d8b2f938debcf93ee31";s:11:"voted_books";a:3:{i:0;s:1:"2";i:1;s:1:"3";i:2;s:1:"4";}}', 504, 'guest1'),
	('d2uhdoe9fnl70jft34qsdiomg4', 1, 0, '1437315988', '__default|a:8:{s:15:"session.counter";i:52;s:19:"session.timer.start";i:1437315330;s:18:"session.timer.last";i:1437315986;s:17:"session.timer.now";i:1437315987;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:39.0) Gecko/20100101 Firefox/39.0";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":7:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:8:"com_book";O:8:"stdClass":2:{s:5:"books";O:8:"stdClass":2:{s:8:"ordercol";N;s:4:"list";a:4:{s:9:"direction";N;s:5:"limit";s:2:"20";s:8:"ordering";N;s:5:"start";i:0;}}s:4:"edit";O:8:"stdClass":1:{s:4:"book";O:8:"stdClass":1:{s:4:"data";N;}}}s:14:"com_categories";O:8:"stdClass":2:{s:10:"categories";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:9:"extension";s:8:"com_book";}}s:4:"edit";O:8:"stdClass":1:{s:8:"category";O:8:"stdClass":1:{s:4:"data";N;}}}s:9:"com_menus";O:8:"stdClass":2:{s:5:"items";O:8:"stdClass":3:{s:8:"menutype";s:8:"mainmenu";s:10:"limitstart";i:0;s:4:"list";a:4:{s:9:"direction";s:3:"asc";s:5:"limit";s:2:"20";s:8:"ordering";s:5:"a.lft";s:5:"start";d:0;}}s:4:"edit";O:8:"stdClass":1:{s:4:"item";O:8:"stdClass":4:{s:4:"data";N;s:4:"type";N;s:4:"link";N;s:2:"id";a:0:{}}}}s:4:"item";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:8:"mainmenu";}}s:11:"com_service";O:8:"stdClass":2:{s:8:"services";O:8:"stdClass":2:{s:8:"ordercol";N;s:4:"list";a:4:{s:9:"direction";N;s:5:"limit";s:2:"20";s:8:"ordering";N;s:5:"start";i:0;}}s:4:"edit";O:8:"stdClass":1:{s:7:"service";O:8:"stdClass":1:{s:4:"data";N;}}}}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":28:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"502";s:4:"name";s:10:"Super User";s:8:"username";s:11:"zamfir.gaby";s:5:"email";s:21:"zamfir.gaby@gmail.com";s:8:"password";s:60:"$2y$10$CGWBxrHMSBReDPC99wOAQuacGhfmBkwWbumkHPjax2kGB8VCgJd8C";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-05-07 18:49:28";s:13:"lastvisitDate";s:19:"2015-07-13 06:04:52";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"83990e65af0ef5c9d51419667f2dd68f";}__wf|a:1:{s:13:"session.token";s:32:"c01995427dfa5c565e32de8e90ac226f";}', 502, 'zamfir.gaby');
...
-- Dumping data for table pharmec.ph_ucm_history: ~17 rows (aproximativ)
...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='Available Updates';

-- Dumping data for table pharmec.ph_updates: ~35 rows (aproximativ)
...
INSERT INTO `ph_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
	(1, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.4.3.4', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
	(2, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', '', ''),
	(3, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
	(4, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
	(5, 3, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/nn-NO_details.xml', '', ''),
	(6, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.4.3.2', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
	(7, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
	(8, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', '', ''),
	(9, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
	(10, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.4.1.2', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
	...
	(13, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
	(14, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.4.3.2', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
	(15, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
	(16, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
	...
	(21, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.4.2.2', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
	(22, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
	(23, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
	(24, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
	(25, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
	...
	(28, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
	(29, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
	...
	(32, 3, 0, 'FrenchCA', '', 'pkg_fr-CA', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
	(33, 3, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.3.0.2', '', 'http://update.joomla.org/language/details3/cy-GB_details.xml', '', ''),
	(34, 3, 0, 'Sinhala', '', 'pkg_si-LK', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/si-LK_details.xml', '', ''),
	(35, 3, 0, 'Dari Persian', '', 'pkg_prs-AF', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/prs-AF_details.xml', '', '');
...
INSERT INTO `ph_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1437315340, ''),
	(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1437315340, ''),
	(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1437315338, ''),
	(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1437315338, ''),
	(5, 'JCE Editor Updates', 'extension', 'https://www.joomlacontenteditor.net/index.php?option=com_updates&view=update&format=xml&id=1&file=extension.xml', 1, 1437315338, '');
...
-- Dumping data for table pharmec.ph_users: ~4 rows (aproximativ)
...
INSERT INTO `ph_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(502, 'Super User', 'zamfir.gaby', 'zamfir.gaby@gmail.com', '$2y$10$CGWBxrHMSBReDPC99wOAQuacGhfmBkwWbumkHPjax2kGB8VCgJd8C', 0, 1, '2015-05-07 18:49:28', '2015-07-19 14:15:34', '0', '', '0000-00-00 00:00:00', 0, '', '', 0),
	...
	(504, 'guest1', 'guest1', 'test@yahoo.com', '$2y$10$yFxtOv7uyADjJTX7Ai/VYuaYXq7CV6X.PHq9bcUfwKh4mfmLkNpke', 0, 0, '2015-07-08 07:33:49', '2015-07-19 14:21:29', '', '{}', '0000-00-00 00:00:00', 0, '', '', 0),
...
-- Dumping data for table pharmec.ph_user_usergroup_map: ~4 rows (aproximativ)
