...
-- Dumping data for table pharmec.ph_assets: ~64 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_menu: ~30 rows (aproximativ)
DELETE FROM `ph_menu`;
...
-- Dumping data for table pharmec.ph_modules: ~18 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_modules_menu: ~20 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_schemas: ~3 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_ucm_history: ~7 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_updates: ~0 rows (aproximativ)
...
INSERT INTO `ph_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1431869534, ''),
	(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1431869534, ''),
	(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 0, ''),
	(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1431869532, '');
...
-- Dumping data for table pharmec.ph_users: ~1 rows (aproximativ)
...
INSERT INTO `ph_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(502, 'Super User', 'zamfir.gaby', 'zamfir.gaby@gmail.com', '$2y$10$CGWBxrHMSBReDPC99wOAQuacGhfmBkwWbumkHPjax2kGB8VCgJd8C', 0, 1, '2015-05-07 18:49:28', '2015-05-23 17:37:42', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
...
-- Dumping data for table pharmec.ph_user_usergroup_map: ~1 rows (aproximativ)
