...
DROP DATABASE IF EXISTS `pharmec`;
...
INSERT INTO `ph_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
	...
	(57, 1, 125, 126, 1, 'com_partner', 'COM_PARTNER', '{}'),
	...
	(64, 1, 127, 134, 1, 'com_service', 'COM_SERVICE', '{}'),
	(65, 64, 128, 129, 2, 'com_service.category.9', 'Servicii Telekom', ''),
	(66, 64, 130, 131, 2, 'com_service.category.10', 'Servicii Avast', ''),
	(67, 64, 132, 133, 2, 'com_service.category.11', 'Servicii Pharmec', ''),
	(68, 18, 86, 87, 2, 'com_modules.module.90', 'Test', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
	(69, 18, 88, 89, 2, 'com_modules.module.91', 'Meniu', '{"core.delete":[],"core.edit":[],"core.edit.state":[],"module.edit.frontend":[]}'),
	(70, 1, 135, 136, 1, 'com_jce', 'JCE', '{}'),
	(71, 1, 137, 138, 1, 'com_booking', 'COM_BOOKING', '{}'),
	(72, 18, 90, 91, 2, 'com_modules.module.92', 'Pharmec Right Booking', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
	(73, 18, 92, 93, 2, 'com_modules.module.93', 'Footer Newsletter', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
	(74, 1, 139, 140, 1, 'com_pharmec', 'Pharmec', '{}');
...
-- Dumping data for table pharmec.ph_booking: 18 rows
...
-- Dumping data for table pharmec.ph_modules_menu: ~37 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_updates: ~39 rows (aproximativ)
...
INSERT INTO `ph_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
	(502, 'Super User', 'zamfir.gaby', 'zamfir.gaby@gmail.com', '$2y$10$CGWBxrHMSBReDPC99wOAQuacGhfmBkwWbumkHPjax2kGB8VCgJd8C', 0, 1, '2015-05-07 18:49:28', '2015-06-30 11:17:55', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
