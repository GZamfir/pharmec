...
-- Dumping data for table pharmec.ph_assets: ~62 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_content_types: ~14 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_extensions: ~133 rows (aproximativ)
...
-- Dumping data for table pharmec.ph_menu: ~25 rows (aproximativ)
DELETE FROM `ph_menu`;
...
-- Dumping data for table pharmec.ph_schemas: ~2 rows (aproximativ)
