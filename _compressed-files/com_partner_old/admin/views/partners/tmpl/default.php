...
<form action="index.php?option=com_partner&view=partners" method="post" id="adminForm" name="adminForm">
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <th width="35%">
                <?php echo JHtml::_('grid.sort', 'COM_PARTNER_PARTNERS_NAME', 'title', $listDirn, $listOrder); ?>            </th>
            <th width="45%">
                <?php echo JHtml::_('grid.sort', 'COM_PARTNER_PARTNERS_LINK', 'link', $listDirn, $listOrder); ?>            </th>
            <th width="5%">
