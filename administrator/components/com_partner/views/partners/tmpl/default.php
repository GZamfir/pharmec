...
<form action="index.php?option=com_partner&view=partners" method="post" id="adminForm" name="adminForm">
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <th width="65%">
                <?php echo JHtml::_('grid.sort', 'COM_PARTNER_PARTNERS_NAME', 'name', $listDirn, $listOrder); ?>            </th>
            <th width="15%">
                <?php echo JHtml::_('grid.sort', 'COM_PARTNER_PARTNERS_WEBSITE', 'website', $listDirn, $listOrder); ?>            </th>
            <th width="5%">
